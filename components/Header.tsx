    ...
    <header>
      ...
      >
        <div
         ...
         h-96 bg-gradient-to-br from-[#3d0280] to-[#52f2bf]
        ...
        >
         ...
         bg-white rounded-md p-2 shadow-md flex-1
          ...
          <Avatar name='Husain Bhattiwala' size='50' round color='#0055d1' />
        </div>
      </div>
      ...
      <div className='flex items-center justify-center py-2 md:py-5'>
        ...
        pr-5 shadow-xl rounded-xl w-fit
         bg-white italic max-w-3xl text-[#005dd1]'
        >
          <UserCircleIcon

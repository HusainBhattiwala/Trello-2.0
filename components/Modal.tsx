...
import TaskedTypeRadioGroup from "./TaskedTypeRadioGroup";
...
function Modal() {
  ...
  const [isOpen, closeModal] = userModalStore((state) => [
    state.isOpen,
    state.closeModal,
  ]);
              ...
              >
                ...
                <div className='mt-2'>
                  <button
                    ...
                    className='w-full border border-gray-300 rouded-md outline-none p-5 focus-visible:ring-2
                  ...
                  {image && (
                    <Image
                      ...
                      width={200}
                      height={200}
                      className='w-full h-44 object-cover mt-2 filter hover:greyscale
